...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_features):
        ...
        # self.linear = nn.Linear(64*8*8, num_features)
...
class ClassificationNet(nn.Module):
    def __init__(self, embedding_net, num_features, num_classes):
        ...
        self.lsoftmax_linear = LSoftmaxLinear(
            input_features=2, output_features=num_classes, margin=4)
    ...
    def forward(self, x, target=None):
        ...
        scores = self.lsoftmax_linear(output, target)
        return scores
...
def resnet20(num_features = 64, num_classes = 10):
    embedding_net = ResNet(BasicBlock, [3, 3, 3], num_features)
    resnet = ClassificationNet(embedding_net, num_features, num_classes)
    return resnet


def resnet32(num_features = 64, num_classes = 10):
    embedding_net = ResNet(BasicBlock, [5, 5, 5], num_features)
    resnet = ClassificationNet(embedding_net, num_features, num_classes)
    return resnet
    
    
def resnet44(num_features = 64, num_classes = 10):
    embedding_net = ResNet(BasicBlock, [7, 7, 7], num_features)
    resnet = ClassificationNet(embedding_net, num_features, num_classes)
    return resnet


def resnet56(num_features = 64, num_classes = 10):
    embedding_net = ResNet(BasicBlock, [9, 9, 9], num_features)
    resnet = ClassificationNet(embedding_net, num_features, num_classes)
    return resnet


def resnet110(num_features = 64, num_classes = 10):
    embedding_net = ResNet(BasicBlock, [18, 18, 18], num_features)
    resnet = ClassificationNet(embedding_net, num_features, num_classes)
    return resnet


def resnet1202(num_features = 64, num_classes = 10):
    embedding_net = ResNet(BasicBlock, [200, 200, 200], num_features)
    resnet = ClassificationNet(embedding_net, num_features, num_classes)
    return resnet
